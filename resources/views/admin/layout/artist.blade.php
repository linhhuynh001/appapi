    ...
    <div class="col-lg-12 col-md-12 col-12">
        ...
        <div class="border-bottom pb-3 d-lg-flex align-items-center justify-content-between">
            <div class="mb-2 mb-lg-0">
                <h1 class="mb-0 h2 fw-bold">All Artist </h1>
                <!-- Breadcrumb -->
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:void()">Artist</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="row">
        <div class="col-md-12 col-12 mb-5">
            ...
            <div class="show-content" style="display:none">
                <form action="{{ route('get.artist.add') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="">subscribeNumber</label>
                            <input type="number" name="subscribeNumber" class="form-control" required>
                        </div>
                        <div class="mb-3">
                                    ...
                                    <tbody>
                                        @foreach ($artist as $key => $artists)
                                            <tr class="odd">
                                                ...
                                                <td><?= $artists->name ?></td>
                                                <td><?= $artists->subscribeNumber ?></td>
                                                <td><?= date('d/m/Y',strtotime($artists->created_at)) ?></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
