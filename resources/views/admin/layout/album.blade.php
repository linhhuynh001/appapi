    ...
    <div class="col-lg-12 col-md-12 col-12">
        ...
        <div class="border-bottom pb-3 d-lg-flex align-items-center justify-content-between">
            <div class="mb-2 mb-lg-0">
                <h1 class="mb-0 h2 fw-bold">All Albums </h1>
                <!-- Breadcrumb -->
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:void()">Album</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="row">
        <div class="col-md-12 col-12 mb-5">
            ...
            <div class="show-content" style="display:none">
                <form action="{{ route('get.album.add') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                    ...
                                    <tbody>
                                        @foreach ($album as $key => $albums)
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    @if($albums->image != '')
                                                        <img src="{{ asset('public'.$albums->image) }}" width="50px">
                                                    @endif
                                                    
                                                </td>
                                                <td><?= $albums->playCount ?></td>
                                                <td><?= date('d/m/Y',strtotime($albums->created_at)) ?></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
